# Retired fleet follow-up ledger

This legacy path is retained temporarily for compatibility with the vendored
`standardize-repo` v0.6.2 skill, which still links here. The original one-off
follow-up list was retired after the July 2026 fleet reconciliation; it is not a
