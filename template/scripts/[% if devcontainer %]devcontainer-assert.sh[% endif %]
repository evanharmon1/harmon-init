...
# success-note. See
# openspec/changes/archive/2026-09-05-bot-autonomy-new-harnesses/tasks.md
# task 5.5.
...
assert_container() {
    ...
    if [ "$profile" = "bot" ]; then
        ...
        *) fail "bot git name '${git_name}' does not end with '-bot'" ;;
        ...
        # openspec/changes/archive/2026-09-05-bot-autonomy-new-harnesses/tasks.md task 5.5 —
