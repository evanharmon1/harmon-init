...
[openspec/changes/dev-flow-v2/specs/renderer/spec.md](https://github.com/evanharmon1/harmon-init/blob/main/openspec/changes/dev-flow-v2/specs/renderer/spec.md)). Invoke via
...
[openspec/changes/dev-flow-v2/specs/evidence/spec.md](https://github.com/evanharmon1/harmon-init/blob/main/openspec/changes/dev-flow-v2/specs/evidence/spec.md)
§ "Evidence is scanned and safely redacted": every free-text evidence projection SHALL pass the
