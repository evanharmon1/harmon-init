...
expect_output mismatch "Download the 18.3.0 release"
expect_output mismatch "release notes and provenance"
expect_output mismatch "sha256"
expect_output mismatch "https://github.com/can1357/oh-my-pi/releases/tag/v18.3.0"
